...
Metodos_Altas Me=new Metodos_Altas();
     ...
     Notas.setText(Notas1);
        ...
        driverpay.setText(Float.toString(sumadp()));
...
public float resta(){
   ...
   //float bono3=Float.parseFloat(bonito1.getText());
    float suma=Float.parseFloat(txtSuma.getText());
     float total=suma-dedu+bonificacion;
return total;}
...
return suma;}
    ...
    private void initComponents() {
        ...
        driverpay = new javax.swing.JTextField();
        ...
        jPanel7.add(driverpay, new org.netbeans.lib.awtextra.AbsoluteConstraints(700, 380, 110, 30));
        ...
        jLabel38.setText("SANTA JULIA FREIGHT SERVICES LLC v2.0.5");
...
m.Notas(txtDueño,txtCamion,txtPeriodo,Notas,txtAño2);
    ...
    private javax.swing.JTextField driverpay;
